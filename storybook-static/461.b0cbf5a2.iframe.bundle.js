  ...
  [461],
  {
    "./node_modules/@storybook/blocks/dist/Color-KGDBMAHA.mjs": (
      ...
      var R,
        ...
        Note = (0, theming.I4)(components._)(({ theme }) => ({
        ...
        SwatchColor = theming.I4.div(({ theme, active }) => ({
          width: 16,
          height: 16,
          boxShadow: active
        ...
        Input = (0, theming.I4)(components.lV.Input)(({ theme, readOnly }) => ({
          width: "100%",
          paddingLeft: 30,
          paddingRight: 30,
        ...
        ToggleIcon = (0, theming.I4)(dist.QDE)(({ theme }) => ({
          position: "absolute",
          zIndex: 1,
          top: 6,
          right: 7,
        ...
        ColorControl = ({
          ...
          let debouncedOnChange = (0, react.useCallback)(
              debounce_default()(onChange, 200),
              [onChange],
            ),
            {
              value,
