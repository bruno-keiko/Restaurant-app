  ...
  (() => {
    ...
    var De,
      ...
      St = ye(() => {
        ...
        (De = __REACT_DOM__),
          ({
            __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Xs,
            createPortal: it,
            createRoot: Zs,
            findDOMNode: el,
            flushSync: tl,
    ...
    gn(Tt, {
      ...
      StrictMode: () => bo,
      Suspense: () => Wt,
      __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: () => vo,
      cloneElement: () => Eo,
      createContext: () => Oo,
      createElement: () => V,
      createFactory: () => wo,
      ...
      In = ye(() => {
        ...
        (Kl = __STORYBOOK_CORE_EVENTS__),
          ({
            ...
            ARGTYPES_INFO_RESPONSE: Ql,
            CHANNEL_CREATED: Xl,
            CHANNEL_WS_DISCONNECT: Zl,
            CONFIG_ERROR: ec,
            ...
            GLOBALS_UPDATED: uc,
            NAVIGATE_URL: pc,
            PLAY_FUNCTION_THREW_EXCEPTION: fc,
            PRELOAD_ENTRIES: dc,
            PREVIEW_BUILDER_PROGRESS: hc,
            PREVIEW_KEYDOWN: yc,
            REGISTER_SUBSCRIPTION: mc,
            REQUEST_WHATS_NEW_DATA: gc,
            RESET_STORY_ARGS: bc,
            RESULT_WHATS_NEW_DATA: vc,
            SAVE_STORY_REQUEST: Ec,
            SAVE_STORY_RESPONSE: Sn,
            SELECT_STORY: Oc,
            SET_CONFIG: wc,
            SET_CURRENT_STORY: Sc,
            SET_GLOBALS: Tc,
            SET_INDEX: Ic,
            SET_STORIES: Cc,
            SET_WHATS_NEW_CACHE: Pc,
            SHARED_STATE_CHANGED: Rc,
            SHARED_STATE_SET: xc,
            STORIES_COLLAPSE_ALL: _c,
            STORIES_EXPAND_ALL: Ac,
            STORY_ARGS_UPDATED: kc,
            STORY_CHANGED: Nc,
            STORY_ERRORED: jc,
            STORY_INDEX_INVALIDATED: Mc,
            STORY_MISSING: Lc,
            STORY_PREPARED: Dc,
            STORY_RENDERED: Fc,
            STORY_RENDER_PHASE_CHANGED: Bc,
            STORY_SPECIFIED: Tn,
            STORY_THREW_EXCEPTION: Wc,
            STORY_UNCHANGED: Uc,
            TELEMETRY_ERROR: Hc,
            TOGGLE_WHATS_NEW_NOTIFICATIONS: Gc,
            UNHANDLED_ERRORS_WHILE_PLAYING: zc,
            UPDATE_GLOBALS: Yc,
            UPDATE_QUERY_PARAMS: qc,
            UPDATE_STORY_ARGS: $c,
      ...
      Rn = ye(() => {
        ...
        (ru = __STORYBOOK_COMPONENTS__),
          ({
            ...
            codeCommon: sp,
            components: lp,
            createCopyToClipboardFunction: cp,
            getStoryHref: up,
            icons: pp,
            interleaveSeparators: fp,
            nameSpaceClassNames: dp,
            resetComponents: hp,
            withReset: yp,
    ...
    var Hp,
      ...
      jn = ye(() => {
        ...
        X();
        Z();
        (Hp = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: Gp,
            AccessibilityIcon: zp,
            AddIcon: Yp,
            AdminIcon: qp,
            AlertAltIcon: $p,
            AlertIcon: Vp,
            ...
            ArrowLeftIcon: Zp,
            ArrowRightIcon: kn,
            ArrowSolidDownIcon: ef,
            ArrowSolidLeftIcon: tf,
            ArrowSolidRightIcon: nf,
            ArrowSolidUpIcon: rf,
            ArrowUpIcon: of,
            AzureDevOpsIcon: af,
            BackIcon: sf,
            ...
            BoldIcon: hf,
            BookIcon: yf,
            BookmarkHollowIcon: mf,
            BookmarkIcon: gf,
            BottomBarIcon: bf,
            BottomBarToggleIcon: vf,
            BoxIcon: Ef,
            BranchIcon: Of,
            BrowserIcon: wf,
            ButtonIcon: Sf,
            ...
            ChevronLeftIcon: Nf,
            ChevronRightIcon: jf,
            ChevronSmallDownIcon: Mf,
            ChevronSmallLeftIcon: Lf,
            ChevronSmallRightIcon: Df,
            ChevronSmallUpIcon: Ff,
            ChevronUpIcon: Bf,
            ChromaticIcon: Wf,
            ChromeIcon: Uf,
            CircleHollowIcon: Hf,
    ...
    var Mn = uo((st, $t) => {
      ...
      (function (e, t) {
        typeof st == "object" && typeof $t == "object"
          ? ($t.exports = t((Ye(), vn(Tt))))
          : typeof define == "function" && define.amd
            ? define(["react"], t)
            : typeof st == "object"
              ? (st.ReactConfetti = t((Ye(), vn(Tt))))
        ...
        return (function (t) {
          ...
          return (
            ...
            (r.d = function (i, o, a) {
              r.o(i, o) ||
                Object.defineProperty(i, o, { enumerable: !0, get: a });
            }),
            (r.r = function (i) {
              typeof Symbol < "u" &&
                Symbol.toStringTag &&
            ...
            var i = {
              ...
              easeInOutExpo: function (o, a, s, l) {
                ...
                return o === 0
                  ...
                  : o === l
                    ? a + c
                    : (o /= l / 2) < 1
                      ? (c / 2) * Math.pow(2, 10 * (o - 1)) + a
                      : (c / 2) * (2 - Math.pow(2, -10 * --o)) + a;
              },
                  ...
                  o === 0
                    ...
                    : (o /= l) == 1
                      ...
                      : ((p = 0) || (p = 0.3 * l),
                        (c = f) < Math.abs(f)
                          ? ((c = f), (u = p / 4))
                          : (u = (p / (2 * Math.PI)) * Math.asin(f / c)),
                        -c *
                          Math.pow(2, 10 * (o -= 1)) *
                          Math.sin(((o * l - u) * (2 * Math.PI)) / p) +
                          a)
                );
              },
              ...
              easeInOutBack: function (o, a, s, l, c) {
                ...
                return (
                  c === void 0 && (c = 1.70158),
                  (o /= l / 2) < 1
                    ? (p / 2) * (o * o * ((1 + (c *= 1.525)) * o - c)) + a
                    : (p / 2) *
                        ((o -= 2) * o * ((1 + (c *= 1.525)) * o + c) + 2) +
                      a
                );
              },
              ...
              easeOutBounce: function (o, a, s, l) {
                ...
                return (o /= l) < 0.36363636363636365
                  ...
                  : o < 0.7272727272727273
                    ? c * (7.5625 * (o -= 0.5454545454545454) * o + 0.75) + a
                    : o < 0.9090909090909091
                      ? c * (7.5625 * (o -= 0.8181818181818182) * o + 0.9375) +
                        a
                      : c *
                          (7.5625 * (o -= 0.9545454545454546) * o + 0.984375) +
                        a;
              },
              easeInOutBounce: function (o, a, s, l) {
                ...
                return o < l / 2
                  ...
                  : 0.5 * i.easeOutBounce(2 * o - l, 0, c, l) + 0.5 * c + a;
              },
            };
            t.exports = i;
          },
            ...
            var b = (function () {
              function d(k, M, w, O) {
                ...
                (this.context = k),
                  ...
                  (this.radius = p(5, 10)),
                  (this.vx =
                    typeof ie == "number" ? p(-ie, ie) : p(ie.min, ie.max)),
                  (this.vy =
                    typeof Ge == "number" ? p(-Ge, 0) : p(Ge.min, Ge.max)),
                  (this.shape =
                    ((U = 0),
                    (z = 2),
                    Math.floor(U + Math.random() * (z - U + 1)))),
                  (this.angle = (p(0, 360) * Math.PI) / 180),
                  (this.angularSpin = p(-0.2, 0.2)),
                  (this.color = xe[Math.floor(Math.random() * xe.length)]),
                  (this.rotateY = p(0, 1)),
                  (this.rotationDirection = p(0, 1) ? o.Positive : o.Negative);
              }
              var h, g, y;
              return (
                (h = d),
                      ...
                      (this.x += this.vx),
                        ...
                        this.rotationDirection === o.Positive
                          ...
                          : this.rotateY <= -1 &&
                            this.rotationDirection === o.Negative &&
                            (this.rotationDirection = o.Positive);
                      var ne = 0.1 * this.rotationDirection;
                      if (
                        ((this.rotateY += ne),
            ...
            var T = function d(h, g) {
              ...
              (function (M, w) {
                ...
                m(this, "animate", function () {
                  ...
                  if (rt < ie) {
                    U !== ie &&
                      ((y.tweenInitTime = Bt), (y.lastNumberOfPieces = ie));
                    for (
                      var dn = y.tweenInitTime,
                        oo = Dt(
                          Bt - dn > nt ? nt : Math.max(0, Bt - dn),
                          rt,
                          ie,
                          nt,
                        ),
                    ...
                    y.particles.forEach(function (ot, mn) {
                      ot.update(),
                        (ot.y > M.height ||
                          ...
                          ot.x < -100) &&
                          (xe && rt <= ie
                            ? (y.particles[mn] = y.getParticle())
                            : y.removeParticleAt(mn));
                    }),
                    Ft > 0 || rt < ie
                  );
                }),
              ...
              R = (function () {
                function d(k, M) {
                  ...
                  (function (U, z) {
                    ...
                    v(this, "rafId", void 0),
                    v(this, "setOptionsWithDefaults", function (U) {
                      var z = {
                        confettiSource: { x: 0, y: 0, w: w.canvas.width, h: 0 },
                      };
                      (w._options = I(I(I({}, z), P), U)),
                        Object.assign(w, U.confettiSource);
                    }),
                    v(this, "update", function () {
                      ...
                      z &&
                        ((ie.fillStyle = "white"),
                        ie.clearRect(0, 0, xe.width, xe.height)),
                        w.generator.animate()
                          ? (w.rafId = requestAnimationFrame(w.update))
                          : (ne &&
                              typeof ne == "function" &&
                    ...
                    v(this, "stop", function () {
                      (w.options = { run: !1 }),
                        w.rafId &&
                          (cancelAnimationFrame(w.rafId), (w.rafId = void 0));
                    }),
                    (this.canvas = k);
                  var O = this.canvas.getContext("2d");
                  if (!O) throw new Error("Could not get canvas context");
                  (this.context = O),
                    (this.generator = new T(this.canvas, function () {
                      return w.options;
                    })),
                    (this.options = M),
                    this.update();
                  ...
                  (g = [
                    {
                      ...
                      set: function (k) {
                        var M = this._options && this._options.run,
                          w = this._options && this._options.recycle;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function Ze(d, h) {
              return (
                ...
                (function (g, y) {
                  if (
                    !(typeof Symbol > "u" || !(Symbol.iterator in Object(g)))
                  ) {
                    var k = [],
                      M = !0,
                      w = !1,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function Ue(d, h) {
              if (d) {
                ...
                return (
                  g === "Object" && d.constructor && (g = d.constructor.name),
                  g === "Map" || g === "Set"
                    ? Array.from(d)
                    : g === "Arguments" ||
            ...
            function pe(d, h) {
              return !h || (B(h) !== "object" && typeof h != "function")
                ? fe(d)
                : h;
            }
            function fe(d) {
            ...
            var S = s.a.createRef(),
              N = (function (d) {
                ...
                function M(w) {
                  ...
                  return (
                    we(
                      fe((O = k.call.apply(k, [this, w].concat(z)))),
                      "canvas",
                      s.a.createRef(),
                    ),
            ...
            var G = s.a.forwardRef(function (d, h) {
              return s.a.createElement(N, te({ canvasRef: h }, d));
            });
            n.default = G;
          },
        ]).default;
    ...
    function ae(e, t) {
      ...
      if (e && Dn(e) && t && Dn(t)) {
        ...
        if (Array.isArray(e) && Array.isArray(t)) return ni(e, t);
        if (e instanceof Map && t instanceof Map) return oi(e, t);
        if (e instanceof Set && t instanceof Set) return ii(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return ri(e, t);
        if (Ln(e) && Ln(t)) return e.source === t.source && e.flags === t.flags;
    ...
    function fi(e, t, n) {
      return Or(e, t)
        ? [e, t].every(j.array)
          ? !e.some(Hn(n)) && t.some(Hn(n))
          : [e, t].every(j.plainObject)
            ? !Object.entries(e).some(Un(n)) && Object.entries(t).some(Un(n))
            : t === n
        : !1;
    }
    function Fn(e, t, n) {
      let { actual: r, key: i, previous: o, type: a } = n,
        s = Te(e, i),
        l = Te(t, i),
        c = [s, l].every(j.number) && (a === "increased" ? s < l : s > l);
      return (
    ...
    function Bn(e, t, n) {
      ...
      if (!j.nullOrUndefined(o)) {
        if (j.defined(l)) {
          if (j.array(l) || j.plainObject(l)) return fi(l, c, o);
        } else return ae(c, o);
        return !1;
      }
    ...
    function Un(e) {
      return ([t, n]) =>
        j.array(e)
          ? ae(e, n) || e.some((r) => ae(r, n) || (j.array(n) && on(n)(r)))
          : j.plainObject(e) && e[t]
            ? !!e[t] && ae(e[t], n)
            : ae(e, n);
    }
    ...
    function xt(e, t) {
      ...
      return {
        added: (n, r) => {
          try {
            return Bn(e, t, { key: n, type: "added", value: r });
          } catch {
            return !1;
          }
        },
        changed: (n, r, i) => {
          try {
            ...
            return [o, a].every(j.array) || [o, a].every(j.plainObject)
              ? !ae(o, a)
              : o !== a;
          } catch {
            return !1;
        ...
        removed: (n, r) => {
          try {
            return Bn(e, t, { key: n, type: "removed", value: r });
          } catch {
            return !1;
          }
        },
    ...
    function Qt(e) {
      return e.parentNode !== null ? Qt(e.parentNode) : e;
    }
    function _t(e, t) {
      ...
      if ((e !== a && t !== a) || r.contains(i)) return Ei(a) ? a : $e(a);
      var s = Qt(e);
      return s.host ? _t(s.host, t) : _t(e, Qt(t).host);
    }
    function Ve(e) {
      var t =
    ...
    function Ir(e) {
      ...
      return { height: qn("Height", t, n, r), width: qn("Width", t, n, r) };
    }
    function je(e) {
    ...
    function Xt(e) {
      ...
      if (l || c) {
        var p = We(e);
        (l -= Yn(p, "x")), (c -= Yn(p, "y")), (i.width -= l), (i.height -= c);
      }
      return je(i);
    }
    function sn(e, t) {
    ...
    function Rr(e, t, n, r, i) {
      ...
      var a = ln(n, r, o, i),
        ...
        l = Object.keys(s)
          .map(function (f) {
            return de({ key: f }, s[f], { area: Ii(s[f]) });
          })
          .sort(function (f, b) {
    ...
    function kr(e, t, n) {
      var r = n === void 0 ? e : e.slice(0, Ci(e, "name", n));
      return (
    ...
    function xi(e, t, n, r) {
      (n.updateBound = r),
        jr(e).addEventListener("resize", n.updateBound, { passive: !0 });
      var i = yt(e);
      return (
    ...
    function ki() {
      this.state.eventsEnabled &&
        ...
        (this.state = Ai(this.reference, this.state)));
    }
    function un(e) {
    ...
    function ji(e) {
      return (
        ...
        Ni(e.instance.popper, e.attributes),
        e.arrowElement &&
    ...
    function Fi(e, t) {
      ...
      var a = o !== void 0 ? o : t.gpuAcceleration,
        ...
        p = Li(e, window.devicePixelRatio < 2 || !Di),
        ...
        a.forEach(function (s, l) {
          ...
          (f || I || R) &&
            ...
            (e.offsets.popper = de(
              {},
              e.offsets.popper,
              Ar(e.instance.popper, e.offsets.reference, e.placement),
            )),
    ...
    function zi(e, t, n, r) {
      ...
      return (
        (c = c.map(function (p, u) {
          ...
          return p
            .reduce(function (m, T) {
              return m[m.length - 1] === "" && ["+", "-"].indexOf(T) !== -1
    ...
    function qi(e, t) {
      ...
      return (
        c.forEach(function (f) {
          var b = ["left", "top"].indexOf(f) !== -1 ? "primary" : "secondary";
          p = de({}, p, u[b](f));
        }),
        (e.offsets.popper = p),
        e
    ...
    function $i(e) {
      ...
      if (r) {
        var i = e.offsets,
          ...
          l = s ? "left" : "top",
          c = s ? "width" : "height",
          p = { start: Ke({}, l, o[l]), end: Ke({}, l, o[l] + o[c] - a[c]) };
    ...
    function le(e, t) {
      ...
      if (e && Jn(e) && t && Jn(t)) {
        if (e.constructor !== t.constructor) return !1;
        if (Array.isArray(e) && Array.isArray(t)) return aa(e, t);
        if (e instanceof Map && t instanceof Map) return la(e, t);
        if (e instanceof Set && t instanceof Set) return ca(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return sa(e, t);
        if (Kn(e) && Kn(t)) return e.source === t.source && e.flags === t.flags;
        if (e.valueOf !== Object.prototype.valueOf)
          return e.valueOf() === t.valueOf();
        if (e.toString !== Object.prototype.toString)
          return e.toString() === t.toString();
    ...
    function pa(e, t, n) {
      return Br(e, t)
        ? [e, t].every(D.array)
          ? !e.some(tr(n)) && t.some(tr(n))
          : [e, t].every(D.plainObject)
            ? !Object.entries(e).some(er(n)) && Object.entries(t).some(er(n))
            : t === n
        : !1;
    }
    function Qn(e, t, n) {
      var r = n.actual,
        ...
        s = Ie(e, i),
        l = Ie(t, i),
        c = [s, l].every(D.number) && (a === "increased" ? s < l : s > l);
      return (
    ...
    function Xn(e, t, n) {
      ...
      if (!D.nullOrUndefined(o)) {
        if (D.defined(l)) {
          if (D.array(l) || D.plainObject(l)) return pa(l, c, o);
        } else return le(c, o);
        return !1;
      }
      return [a, s].every(D.array)
        ...
        : [a, s].every(D.plainObject)
          ? fa(Object.keys(l), Object.keys(c))
    ...
    function Zn(e, t, n) {
      ...
      if (!ua(o, a)) throw new TypeError("Inputs don't have length");
      return (
    ...
    function da(e, t) {
      ...
      var n = function (u, f) {
          try {
            return Xn(e, t, { key: u, type: "added", value: f });
          } catch {
            return !1;
          }
        },
        r = function (u, f, b) {
          try {
            ...
            return [m, T].every(D.array) || [m, T].every(D.plainObject)
              ? !le(m, T)
              : m !== T;
          } catch {
            return !1;
        ...
        p = function (u, f) {
          try {
            return Xn(e, t, { key: u, type: "removed", value: f });
          } catch {
            return !1;
          }
        };
    ...
    function Ta(e, t) {
      ...
      if (t && typeof t != "string") throw new TypeError(Ea);
    }
    function or(e, t, n) {
      return (
        Ta(e, n),
    ...
    function Yr(e) {
      ...
      return (
        ...
        (a || o) &&
          !D.boolean(i) &&
          (c.close = E.createElement(zr, { styles: l.close, handleClick: r })),
        E.createElement(
          "div",
    ...
    function _a(e) {
      var t = (0, en.default)(xa, e.options || {});
      return {
        wrapper: {
          cursor: "help",
          display: "inline-flex",
    ...
    function Ha(e, t) {
      ...
      return new Promise((i, o) => {
        let { scrollTop: a } = r,
          s = e > a ? e - a : a - e;
        hi.default.top(r, e, { duration: s < 100 ? 50 : n }, (l) =>
          l && l.message !== "Element already at target scroll position"
            ? o(l)
            : i(),
        );
      });
    ...
    function Xa(e, t) {
      ...
      let { floaterProps: s, styles: l } = e,
        c = (0, Pt.default)((n = t.floaterProps) != null ? n : {}, s ?? {}),
        p = (0, Pt.default)(l ?? {}, (r = t.styles) != null ? r : {}),
        u = (0, Pt.default)(Qa, p.options || {}),
      ...
      let m = {
        ...
        T = {
          ...
          beaconOuter: {
            ...
            backgroundColor: `rgba(${za(u.primaryColor).join(",")}, 0.2)`,
          ...
          overlayLegacy: { ...m },
          overlayLegacyCenter: { ...m, backgroundColor: u.overlayColor },
          spotlight: { ...lr, backgroundColor: "gray" },
          spotlightLegacy: {
            ...lr,
          ...
          floaterStyles: {
            arrow: {
              color:
                (a =
                  (o = (i = c?.styles) == null ? void 0 : i.arrow) == null
                    ? void 0
                    : o.color) != null
                  ? a
                  : u.arrowColor,
    ...
    function qe(e, t) {
      ...
      return (
        ...
        (f.offset +=
          (a = (o = e.spotlightPadding) != null ? o : c.spotlightPadding) !=
          null
            ? a
            : 0),
        c.placementBeacon &&
    ...
    function us(e) {
      ...
      return (
        r &&
          ((J.primary = o ? K : B),
          F &&
            (J.primary = V("span", null, J.primary, " (", i + 1, "/", s, ")"))),
        J.primary &&
          (J.primary = V(
            "button",
            {
        ...
        V(
          ...
          V(
            ...
            v && V("h1", { "aria-label": ke(v), style: x.tooltipTitle }, v),
    ...
    function Is({ step: e, steps: t, onClose: n, onComplete: r }) {
      let [i, o] = ue(null),
        a = _n();
      return (
        ce(() => {
          ...
          : E.createElement(hs, {
              ...
              styles: {
                overlay: {
                  mixBlendMode: "unset",
                  backgroundColor:
                    t[i]?.target === "body" ? "rgba(27, 28, 29, 0.2)" : "none",
                },
                spotlight: {
      ...
      return (
        ...
        it(
          E.createElement(
            ...
            E.createElement(hr.default, { colors: i, drawShape: xs, ...o }),
          ),
          a,
        )
      );
    ...
    function xs(e) {
      switch (((this.shape = this.shape || Rs(1, 6)), this.shape)) {
        case 2: {
          let t = this.w / 2,
            n = this.h / 2;
          e.moveTo(-t + 2, -n),
    ...
    function fr({ targetSelector: e, pulsating: t = !1 }) {
      return (
        ce(() => {
    ...
    function Gs({ api: e }) {
      let [t, n] = ue(!0),
        ...
        T = ze(
          (B) => {
            try {
              let { id: te, refId: J } = e.getCurrentStoryData() || {};
        ...
        I = ze(() => {
          e.emit(pr, { step: "6:FinishedOnboarding", type: "telemetry" }),
      ...
      if (
        ...
        ce(() => {
          a((B) =>
            ["1:Intro", "5:StoryCreated", "6:FinishedOnboarding"].includes(B)
              ? B
              : u
                ? "4:CreateStory"
                : c
        ...
        ce(() => e.emit(pr, { step: o, type: "telemetry" }), [e, o]),
        !t)
      )
        return null;
      ...
      ro = ye(() => {
        ...
        (hr = po(Mn())),
          ...
          (he = (e, t) =>
            function () {
              return (
                t || (0, e[mr(e)[0]])((t = { exports: {} }).exports, t),
                t.exports
              );
            }),
          (zo = (e, t, n, r) => {
            ...
            "../../node_modules/scroll/index.js"(e, t) {
              ...
              function a(c) {
                return function (p, u, f, b) {
                  (f = f || {}),
                    typeof f == "function" && ((b = f), (f = {})),
                    typeof b != "function" && (b = l);
                  var m = o(),
                    T = p[c],
                    F = f.ease || s,
                    I = isNaN(f.duration) ? 350 : +f.duration,
                    x = !1;
            ...
            "../../node_modules/deepmerge/dist/cjs.js"(e, t) {
              ...
              function f(v) {
                return Object.getOwnPropertySymbols
                  ? Object.getOwnPropertySymbols(v).filter(function (P) {
            ...
            "../../node_modules/react-is/cjs/react-is.development.js"(e) {
              (function () {
                var t = typeof Symbol == "function" && Symbol.for,
                  ...
                  I = t ? Symbol.for("react.fundamental") : 60117,
            ...
            "../../node_modules/prop-types/factoryWithTypeCheckers.js"(e, t) {
              ...
              t.exports = function (c, p) {
                ...
                function J(S) {
                  ...
                  function N(H, G, d, h, g) {
                    for (var y = H[G], k = 0; k < S.length; k++)
                    ...
                    return new I(
                      "Invalid " +
                        ...
                        String(y) +
                        "` " +
                        ("supplied to `" + d + "`, expected one of " + M + "."),
                    );
                  }
                  return x(N);
                }
...
Valid keys: ` +
        ...
        (Zo = Er("function")),
          ...
          (Dn = (e) => !ti(e) && !ei(e) && (Zo(e) || typeof e == "object")),
          (ti = Er("undefined"));
        (ai = [
          "Array",
          "ArrayBuffer",
        ...
        ui = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"];
        _.array = Array.isArray;
        _.arrayOf = (e, t) =>
          !_.array(e) && !_.function(t) ? !1 : e.every((n) => t(n));
        _.asyncGeneratorFunction = (e) => Nt(e) === "AsyncGeneratorFunction";
        ...
        _.primitive = (e) => _.null(e) || ci(typeof e);
        ...
        (hi = Be(Yo(), 1)),
          ...
          (yi = (function () {
            for (
              ...
              if (ht && navigator.userAgent.indexOf(e[t]) >= 0) return 1;
            return 0;
          })());
        (bi = ht && window.Promise), (vi = bi ? mi : gi);
        (Gn = ht && !!(window.MSInputMethodContext && document.documentMode)),
          (zn = ht && /MSIE 10/.test(navigator.userAgent));
        (wi = function (e, t) {
          if (!(e instanceof t))
            throw new TypeError("Cannot call a class as a function");
        }),
        ...
        Di = ht && /Firefox/i.test(navigator.userAgent);
        (Dr = [
          "auto-start",
          "auto",
          "auto-end",
        ...
        (Ji = {
          shift: { order: 100, enabled: !0, fn: $i },
          offset: { order: 200, enabled: !0, fn: Yi, offset: 0 },
          preventOverflow: {
            order: 300,
            enabled: !0,
            fn: qi,
          ...
          keepTogether: { order: 400, enabled: !0, fn: Hi },
          ...
          hide: { order: 800, enabled: !0, fn: Vi },
          computeStyle: {
            order: 850,
            enabled: !0,
            fn: Fi,
          ...
          (jt = (function () {
            function e(t, n) {
              ...
              wi(this, e),
                ...
                (this.update = vi(this.update.bind(this))),
                ...
                Object.keys(de({}, e.Defaults.modifiers, i.modifiers)).forEach(
                  function (a) {
                ...
                (this.modifiers = Object.keys(this.options.modifiers)
                  .map(function (a) {
                    return de({ name: a }, r.options.modifiers[a]);
                  })
                  .sort(function (a, s) {
        ...
        (ra = Fr("function")),
          ...
          (Jn = function (e) {
            return !ia(e) && !oa(e) && (ra(e) || typeof e == "object");
          }),
          (ia = Fr("undefined")),
          (tn = function (e) {
        ...
        (ba = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }),
          (va =
            ...
            bt(n, [
              {
                ...
                value: function () {
                  Se() &&
                    (this.node || this.appendNode(), ut || this.renderPortal());
                },
              },
              {
                key: "componentDidUpdate",
              ...
              },
              {
                ...
                value: function () {
                  !Se() ||
                    !this.node ||
                    (ut || De.unmountComponentAtNode(this.node),
                    this.node &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var a = De.unstable_renderSubtreeIntoContainer(
                    this,
                    i.length > 1 ? E.createElement("div", null, i) : i[0],
                    this.node,
                  );
                  return o(a), null;
                },
        ...
        oe(Hr, "propTypes", {
          ...
          id: C.default.oneOfType([C.default.string, C.default.number]),
          placement: C.default.string,
          setRef: C.default.func.isRequired,
          target: C.default.oneOfType([C.default.object, C.default.string]),
                    ...
                    E.createElement(
                      ...
                      E.createElement(
                        ...
                        E.createElement(
                          ...
                          E.createElement("polygon", { points: T, fill: l }),
                        ),
                      ),
                    )
                  );
            ...
            bt(n, [
              {
                ...
                get: function () {
                  ...
                  return (
                    s ||
                      (a.startsWith("top")
                        ? (I.padding = "0 0 ".concat(p, "px"))
                        : a.startsWith("bottom")
                          ? (I.padding = "".concat(p, "px 0 0"))
                          : a.startsWith("left")
                            ? (I.padding = "0 ".concat(p, "px 0 0"))
                            : a.startsWith("right") &&
                              (I.padding = "0 0 0 ".concat(p, "px"))),
                    [q.OPENING, q.OPEN].indexOf(l) !== -1 &&
                      (I = ee(ee({}, I), m)),
                    l === q.CLOSING && (I = ee(ee({}, I), b)),
                    l === q.OPEN && !i && (I = ee(ee({}, I), T)),
                    a === "center" && (I = ee(ee({}, I), f)),
                    o && (I = ee(ee({}, I), F)),
                    ee(ee({}, u), I)
                  );
                },
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    i
                      ? E.isValidElement(i)
                        ? (c.content = E.cloneElement(i, { closeFn: o }))
                        : (c.content = i({ closeFn: o }))
                      : (c.content = E.createElement(Yr, this.props)),
                    l === q.OPEN && p.push("__floater__open"),
                    a || (c.arrow = E.createElement(Gr, this.props)),
                    E.createElement(
                      "div",
        ...
        oe(qr, "propTypes", {
          component: C.default.oneOfType([C.default.func, C.default.element]),
        ...
        xa = { zIndex: 100 };
        (Aa = ["arrow", "flip", "offset"]),
          (ka = ["position", "top", "right", "bottom", "left"]),
          (fn = (function (e) {
            vt(n, e);
            var t = Et(n);
            function n(r) {
              ...
              bt(n, [
                ...
                },
                {
                  ...
                  value: function (r, i) {
                    if (Se()) {
                      ...
                      if (r.open !== s) {
                        var b;
                        D.boolean(s) && (b = s ? q.OPENING : q.CLOSING),
                          this.toggle(b);
                      }
                      (r.wrapperOptions.position !== c.position ||
                        ...
                        this.floaterRef &&
                          (f("status", q.OPENING) || f("status", q.CLOSING)) &&
                          Pa(
                            this.floaterRef,
                            "transitionend",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (u === "center") this.setState({ status: q.IDLE });
                      ...
                      var m = this.options,
                        ...
                        I = m.offset,
                        x = Wr(m, Aa);
                      new Vn(i, this.floaterRef, {
                        placement: u,
                        modifiers: ee(
                          {
                            arrow: ee(
                              { enabled: !c, element: this.arrowRef },
                              T,
                            ),
                            flip: ee({ enabled: !s, behavior: b }, F),
                            offset: ee({ offset: "0, ".concat(p, "px") }, I),
                          },
                          x,
                        ),
                        onCreate: function (P) {
                        ...
                        onUpdate: function (P) {
                          ...
                          r._isMounted &&
                            P.placement !== R &&
                            r.setState({ currentPlacement: P.placement });
                        },
                      });
                    }
                    if (o) {
                      var v = D.undefined(f.offset) ? 0 : f.offset;
                      new Vn(this.target, this.wrapperRef, {
                        ...
                        onCreate: function (P) {
                          (r.wrapperPopper = P),
                            r._isMounted &&
                              r.setState({ statusWrapper: q.IDLE }),
                            l(P, "wrapper"),
                            u !== P.placement &&
                              setTimeout(function () {
                                P.instance.update();
                ...
                },
                {
                  ...
                  value: function (r) {
                    var i = this.state.status,
                      o = i === q.OPEN ? q.CLOSING : q.OPENING;
                    D.undefined(r) || (o = r), this.setState({ status: o });
                  },
                },
                {
                  key: "debug",
                ...
                },
                {
                  ...
                  get: function () {
                    var r = this,
                      ...
                      s = i.statusWrapper,
                      l = this.props.styles,
                      c = (0, en.default)(_a(l), l);
                    if (a) {
                      var p;
                      [q.IDLE].indexOf(o) === -1 || [q.IDLE].indexOf(s) === -1
                        ? (p = c.wrapperPosition)
                        : (p = this.wrapperPopper.styles),
                        (c.wrapper = ee(ee({}, c.wrapper), p));
                    }
                    if (this.target) {
                ...
                },
                {
                  ...
                  value: function () {
                    var r = this.state,
                      ...
                      R = {};
                    return (
                      o ? (R.wrapperInPortal = P) : (R.wrapperAsChildren = P),
                      E.createElement(
                        "span",
                        null,
                        E.createElement(
        ...
        oe(fn, "propTypes", {
          ...
          children: C.default.node,
          component: or(
            C.default.oneOfType([C.default.func, C.default.element]),
            function (e) {
              return !e.content;
            },
          ),
          content: or(C.default.node, function (e) {
            return !e.component;
          }),
        ...
        (Na = Be(Xo(), 1)),
          ...
          (Ma = (e, t, n) =>
            t in e
              ...
              : (e[t] = n)),
          (L = (e, t, n) => (Ma(e, typeof t != "symbol" ? t + "" : t, n), n)),
          ($ = {
            INIT: "init",
            START: "start",
            STOP: "stop",
        ...
        (Va = {
          ...
          (lr = { borderRadius: 4, position: "absolute" });
        (Zr = {
          action: "init",
          controlled: !1,
          index: 0,
              ...
              L(this, "beaconPopper"),
                ...
                L(this, "setSteps", (i) => {
                  ...
                  this.data.set("steps", i),
                    a === Y.WAITING && !o && i.length && (s.status = Y.RUNNING),
                    this.setState(s);
                }),
                L(this, "getPopper", (i) =>
                ...
                L(this, "go", (i) => {
                  ...
                  this.setState({
                    ...this.getNextState({ action: $.GO, index: i }),
                ...
                L(this, "next", () => {
                  ...
                  o === Y.RUNNING &&
                    this.setState(
                      this.getNextState({ action: $.NEXT, index: i + 1 }),
                    );
                }),
                L(this, "open", () => {
                ...
                L(this, "prev", () => {
                  ...
                  o === Y.RUNNING &&
                    this.setState({
                      ...this.getNextState({ action: $.PREV, index: i - 1 }),
                    });
                }),
                L(this, "reset", (i = !1) => {
                ...
                L(this, "start", (i) => {
                  ...
                  this.setState({
                    ...this.getNextState(
                      { action: $.START, index: j.number(i) ? i : o },
                      !0,
                    ),
                ...
                L(this, "update", (i) => {
                  ...
                  if (!Ga(i, ur))
                    throw new Error(
                      `State is not valid. Valid keys: ${ur.join(", ")}`,
                    );
                  this.setState({
                    ...this.getNextState(
                      {
          ...
          (os = class extends _e {
            constructor() {
              super(...arguments),
                ...
                L(this, "hideSpotlight", () => {
                  ...
                  return t || (e ? r.includes(n) : n !== W.TOOLTIP);
                }),
                ...
                L(this, "handleScroll", () => {
                  ...
                  } else dt(t, "sticky") && this.updateState({});
                }),
                L(this, "handleResize", () => {
            ...
            componentDidMount() {
              let {
                ...
                i = Ne(r);
              (this.scrollParent = Lt(i ?? document.body, n, !0)),
                (this.isActive = !0),
                !t &&
                  Ot(i, !0) &&
                  Me({
            ...
            get spotlightStyles() {
              ...
              let { showSpotlight: r } = this.state,
                ...
                f = Wa(c, a, i);
              return {
                ...(sr() ? s.spotlightLegacy : s.spotlight),
            ...
            render() {
              ...
              if (r()) return null;
              let a = n !== "center" && e && V(rs, { styles: o });
              if (Kr() === "safari") {
      ...
      `),
            ...
            componentDidMount() {
              ...
              j.domElement(this.beacon) ||
                ...
                setTimeout(() => {
                  j.domElement(this.beacon) && e && this.beacon.focus();
                }, 0);
            }
            componentWillUnmount() {
            ...
            render() {
              let {
                ...
                c = j.string(i.open) ? i.open : (0, Na.default)(i.open),
                p = {
                  "aria-label": c,
                  onClick: o,
                  onMouseEnter: o,
        ...
        (ps = us),
          (fs = class extends _e {
            ...
            render() {
              let {
                ...
                { beaconComponent: a, tooltipComponent: s, ...l } = o,
                c;
              if (s) {
                let p = {
          ...
          (ds = class extends _e {
                ...
                L(this, "setPopper", (e, t) => {
                  ...
                  t === "wrapper"
                    ...
                    a.getPopper("beacon") &&
                      a.getPopper("tooltip") &&
                      i === W.INIT &&
                      a.update({ action: r, lifecycle: W.READY }),
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                { changed: b, changedFrom: m } = xt(e, this.props),
                T = s.info(),
                F = i && n !== $.CLOSE && (l > 0 || n === $.PREV),
                I = b("action") || b("index") || b("lifecycle") || b("status"),
                x = m("lifecycle", [W.TOOLTIP, W.INIT], W.INIT),
                v = b("action", [$.NEXT, $.PREV, $.SKIP, $.CLOSE]),
                P = o && l === e.index;
              if (
                (v &&
                  (x || P) &&
                ...
                K && Ba(R)
                  ...
                  : (console.warn(
                      K ? "Target not visible" : "Target not mounted",
                      u,
                    ),
                    r({ ...T, type: ve.TARGET_NOT_FOUND, step: u }),
                    o || f.update({ index: l + (n === $.PREV ? -1 : 1) }));
              }
              m("lifecycle", W.INIT, W.READY) &&
                f.update({ lifecycle: ar(u) || F ? W.TOOLTIP : W.BEACON }),
                b("index") &&
                  Me({
                    title: `step:${c}`,
                    data: [{ key: "props", value: this.props }],
                ...
                b("lifecycle", W.TOOLTIP) &&
                  ...
                  this.tooltip &&
                    ((this.scope = new as(this.tooltip, {
          ...
          (eo = class extends _e {
            constructor(e) {
              ...
              (this.store = ts({ ...e, controlled: r && j.number(i) })),
            ...
            componentDidUpdate(e, t) {
              ...
              let {
                ...
                { debug: s, run: l, stepIndex: c, steps: p } = this.props,
                ...
                { changed: v, changedFrom: P } = xt(t, this.state),
                R = qe(this.props, p[i]),
                K = !ae(f, p),
              ...
              if (
                (K &&
                  (cr(p, s) ? m(p) : console.warn("Steps are not valid", p)),
                x("run") && (l ? T(c) : F()),
                B)
              ) {
              ...
              if (v("status", [Y.FINISHED, Y.SKIPPED])) {
                ...
                P("status", [Y.IDLE, Y.READY], Y.RUNNING)
                  ? this.callback({ ...J, type: ve.TOUR_START })
                  : (v("status") || v("action", $.RESET)) &&
                    this.callback({ ...J, type: ve.TOUR_STATUS });
              this.scrollToStep(t),
                R.placement === "center" &&
                  a === Y.RUNNING &&
                  o === W.INIT &&
            ...
            scrollToStep(e) {
              ...
              if (r === Y.RUNNING && f) {
                ...
                if (n === W.BEACON && F) {
                  ...
                  let { flipped: x, offsets: v, placement: P } = I;
                  ["top", "right", "left"].includes(P) && !x && !b
                    ? (T = Math.floor(v.popper.top - s))
                    : (T -= p.spotlightPadding);
                }
                (T = T >= 0 ? T : 0),
                  r === Y.RUNNING &&
                    Ha(T, { element: m, duration: a }).then(() => {
                      setTimeout(() => {
                        var x;
...
`),
    ...
    `),
            ...
            E.createElement(
              ...
              E.createElement(
                ...
                E.createElement(
                  vs,
                  null,
                  n.title && E.createElement(Es, null, n.title),
                  E.createElement(
                    Cn,
                    { ...r, onClick: r.onClick, variant: "solid" },
                    E.createElement(Nn, null),
                  ),
                ),
                E.createElement(Os, null, n.content),
              ),
              E.createElement(
                ws,
                { id: "buttonNext" },
                E.createElement(Ss, null, e + 1, " of ", t),
                !n.hideNextButton &&
                  E.createElement(
                    ms,
                    {
        ...
        Cs = re.div(({ width: e, height: t, left: n, top: r }) => ({
          width: `${e}px`,
          height: `${t}px`,
          left: `${n}px`,
          top: `${r}px`,
        ...
        pr = "STORYBOOK_ADDON_ONBOARDING_CHANNEL";
    ...
    X();
    Z();
    var dl = __STORYBOOK_API__,
      {
        ActiveTabs: hl,
        Consumer: yl,
        ManagerContext: ml,
        Provider: gl,
        RequestResponseError: bl,
        addons: wn,
        combineParameters: vl,
        controlOrMetaKey: El,
        controlOrMetaSymbol: Ol,
        eventMatchesShortcut: wl,
        eventToShortcut: Sl,
        experimental_requestResponse: Tl,
        isMacLike: Il,
        isShortcutTaken: Cl,
        keyToSymbol: Pl,
        merge: Rl,
        mockChannel: xl,
        optionOrAltSymbol: _l,
        shortcutMatchesShortcut: Al,
        shortcutToHumanString: kl,
        types: Nl,
        useAddonState: jl,
        useArgTypes: Ml,
        useArgs: Ll,
